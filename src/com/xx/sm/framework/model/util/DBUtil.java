...
//            this.conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/schoolmis_new", "root", "123");
...
//    }
    ...
    public Connection getConnection() {
        ...
        try {
            Class.forName("com.mysql.jdbc.Driver");
            myConn = DriverManager.getConnection("jdbc:mysql://localhost:3306/schoolmis_new", "root", "123");
            //System.out.println("数据库连接成功！");
        } catch (ClassNotFoundException e) {
            e.printStackTrace();
        } catch (SQLException e) {
